...
2a) contractAddressPaymaster=
  - If omitted, you are defaulted to the normal paymaster. Update as needed
  - Replace the value with your own paymaster Ethereum address (42 characters long including '0x' prefix, case-sensitive).
...
-  abiFile                 Token abi in a file (default: 'zkBTC.abi' in the same folder as this miner)

-  web3api                 User-defined web3 provider URL (default: Infura mainnet provider [dev account, for TESTING PURPOSE only])

-  contract                Token contract address (default: zkBTC contract address)

-  contractAddressPaymaster Paymaster contract address (default: zkBTC contract address)
contractAddressPaymaster
