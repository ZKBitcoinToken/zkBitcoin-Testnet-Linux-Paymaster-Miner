...
while : ; do
  dotnet _zkBitcoinMiner.dll allowCPU=false allowIntel=true allowAMD=true allowCUDA=true web3api=https://testnet.era.zksync.dev abiFile=zkBTC.abi contract=0x8508F527e66aaFE4aA6A0B13b1D33c6D13037876 MaxZKBTCperMint=500 MinZKBTCperMint=500 HowManyBlocksAWAYFromAdjustmentToSendMinimumZKBTC=100 gasToMine=0.5  gasApiMax=1 gasLimit=1000000 gasApiURL= gasApiPath=$.safeLow gasApiMultiplier=0.1 gasApiOffset=1.0 privateKey=9f151c742cefc2d813551462c67c60cf9c6e55b6444fdc135ebb2f9d1bb19235
  [[ $? -eq 22 ]] || break
done
