 ...
 while (true) {
				...
				var config2;
					try {
					  ...
					  console.log('contractAddressPayMaster Address:', config.contractAddressPayMaster);
...
if(doEz){
				  ...
				  const gasLimit = await erc20.estimateGas.multiMint_SameAddress_Min_Mined(minAmts.toString(), PAYMASTER_ADDRESS, data22Nonce, data2zzzz,{
					customData: {
				  ...
				  const transaction = await erc20.multiMint_SameAddress_Min_Mined(minAmts.toString(), PAYMASTER_ADDRESS, data22Nonce, data2zzzz, {
				  // paymaster info
				  customData: {
					paymasterParams: paymasterParams,
					gasPerPubdata: utils.DEFAULT_GAS_PER_PUBDATA_LIMIT,
  ...
  // Estimate gas fee for mint transaction
				  ...
				  const gasLimit = await erc20.estimateGas.multiMint_SameAddress_EZ_Min_Mined(minAmts.toString(), PAYMASTER_ADDRESS, data22Nonce, data2zzzz,{
					customData: {
					  gasPerPubdata: utils.DEFAULT_GAS_PER_PUBDATA_LIMIT,
					  paymasterParams: paymasterParams,
					},
				  ...
				  console.log(`Minting 5 tokens for the wallet via paymaster...`);
				  const transaction = await erc20.multiMint_SameAddress_EZ_Min_Mined(minAmts.toString(), PAYMASTER_ADDRESS, data22Nonce, data2zzzz, {
				  // paymaster info
				  customData: {
					paymasterParams: paymasterParams,
					gasPerPubdata: utils.DEFAULT_GAS_PER_PUBDATA_LIMIT,
