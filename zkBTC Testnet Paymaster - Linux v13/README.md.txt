...
2a) contractAddressPaymaster=
  - If omitted, you are able to mine, you just cant use the PayMaster.
  - Replace the value with another Paymaster address (42 characters long including '0x' prefix, case-sensitive).
